...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final YandexLibraryAccessors laccForYandexLibraryAccessors = new YandexLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>yandex</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public YandexLibraryAccessors getYandex() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForYandexLibraryAccessors;
    }
    ...
    public static class PlayservicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>playservices.location</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getLocation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("playservices.location");
        }
     ...
     */
    @Deprecated
    public static class YandexLibraryAccessors extends SubDependencyFactory {

        public YandexLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>maps</b> with <b>com.yandex.android:maps.mobile</b> coordinates and
         * with version reference <b>yandex.maps</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final YandexVersionAccessors vaccForYandexVersionAccessors = new YandexVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.playservices</b>
         */
        public PlayservicesVersionAccessors getPlayservices() {
            return vaccForPlayservicesVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.yandex</b>
         */
        public YandexVersionAccessors getYandex() {
            return vaccForYandexVersionAccessors;
        }
    ...
    public static class GmsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>gms.maps</b> with value <b>18.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PlayservicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>playservices.location</b> with value <b>21.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLocation() { return getVersion("playservices.location"); }

    }

    public static class YandexVersionAccessors extends VersionFactory  {

        public YandexVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>yandex.maps</b> with value <b>4.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaps() { return getVersion("yandex.maps"); }
